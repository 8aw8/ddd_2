...
begin
 if MessageBox(Form5.Handle,'Вы действительно хотите удалить эту вакансию?','Удаление вакансии',mb_yesno)=6 then
...
if Form5.act=act_update then
 with  Form5.ADOQuery1 do begin
  ...
  Post;
  TabControl1.TabIndex:=TabControl1.Tabs.Add('Новый');
 end;//with
...
begin
 if MessageBox(Form5.Handle,'Вы хотите удалить данное контактное лицо','Удаление контактного лица',mb_yesno)=6 then begin
